...
const CheckmateText = ({ onComplete }: { onComplete: () => void }) => {
    ...
    useEffect(() => {
        scale.value = withSequence(
            ...
            withDelay(1000, withTiming(0, { duration: 300 })) // Zoom Out biến mất
        );

        opacity.value = withSequence(
            withTiming(1, { duration: 200 }), // Hiện ra dần
            withDelay(1000, withTiming(0, { duration: 300 })) // Mờ dần biến mất
        );
